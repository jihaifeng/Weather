...
public class LauarUtils {
  private static int monCyl, dayCyl, yearCyl;
  private static int year, month, day;
  private static boolean isLeap;
  private static int[] lunarInfo = {
      0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554, 0x056a0, 0x09ad0, 0x055d2, 0x04ae0, 0x0a5b6, 0x0a4d0, 0x0d250, 0x1d255, 0x0b540, 0x0d6a0, 0x0ada2, 0x095b0, 0x14977, 0x04970, 0x0a4b0, 0x0b4b5, 0x06a50, 0x06d40, 0x1ab54, 0x02b60, 0x09570, 0x052f2, 0x04970, 0x06566, 0x0d4a0, 0x0ea50, 0x06e95, 0x05ad0, 0x02b60, 0x186e3, 0x092e0, 0x1c8d7, 0x0c950, 0x0d4a0, 0x1d8a6, 0x0b550, 0x056a0, 0x1a5b4, 0x025d0, 0x092d0, 0x0d2b2, 0x0a950, 0x0b557, 0x06ca0, 0x0b550, 0x15355, 0x04da0, 0x0a5d0, 0x14573, 0x052d0, 0x0a9a8, 0x0e950, 0x06aa0, 0x0aea6, 0x0ab50, 0x04b60, 0x0aae4, 0x0a570, 0x05260, 0x0f263, 0x0d950, 0x05b57, 0x056a0, 0x096d0, 0x04dd5, 0x04ad0, 0x0a4d0, 0x0d4d4, 0x0d250, 0x0d558, 0x0b540, 0x0b5a0, 0x195a6, 0x095b0, 0x049b0, 0x0a974, 0x0a4b0, 0x0b27a, 0x06a50, 0x06d40, 0x0af46,
  ...
  //传回农历 y年的总天数
  private static int oneYearDays(int y) {
    int i;
    int sum = 348; //29*12
  ...
  private static void LunarData(Date objDate) {
    int i, leap = 0, temp = 0;
  ...
  public static String getLunar(int year, int month, int day) {
    ...
    //日期
    LunarData(sDObj); //农历
    String ganzhi = cyclical(getYearCyl());
    String animal = Animals[sy];
    ...
    String data = monthOfAlmanac[getMonth()-1] + daysOfAlmanac[getDay()-1];
    String  lauarData = ganzhi + "\b" + animal + "年\b" + data;
    return lauarData;
  }
}